package kh.or.iei.point.controller;

import java.util.Scanner;

import kh.or.iei.point.vo.Gold;
import kh.or.iei.point.vo.Silver;
import kh.or.iei.point.vo.Vip;
...
public class PointController {
	...
	public void printAllUeser() {
		...
		for (int i = 0; i < sIndex; i++) {
			System.out.println(silver[i].getGrade() + "\t" + silver[i].getName() + "\t" + silver[i].getPoint()+"\t" + silver[i].getBonus());
		}
		for (int i = 0; i < gIndex; i++) {
			System.out.println(gold[i].getGrade() + "\t" + gold[i].getName() + "\t" + gold[i].getPoint()+"\t" + gold[i].getBonus());
		}
		for (int i = 0; i < vIndex; i++) {
			System.out.println(vip[i].getGrade() + "\t" + vip[i].getName() + "\t" +vip[i].getPoint()+"\t" + vip[i].getBonus());
		}
